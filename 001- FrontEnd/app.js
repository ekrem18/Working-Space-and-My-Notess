...
//? *********************************** SYNC & ASYNC ***********************************
//* JS Timing , Event ve http isteklerinde asenkron çalışıyor. Aşağıdaki örnekte de senkron çalışan kod asenkronu beklemez.
// console.log("Ekrm");
// setTimeout( ()=>{
...
//+ ***POLYMORPHISM*** Polymorphism, bir değişken, fonksiyon veya nesnenin çoklu şekiller alabilmesini tanimlayan bir nesne-yonelimli programlama teknigidir. Polymorphism, genellikle Overloading ve Overriding gibi alt kavramlar ile bilinir.
...
//*+  İşin içinde interaktivite varsa eğer en yukarda "use client" şeklinde tanımlama yapmamız gerekiyor. onClick vs var ise mesela...
